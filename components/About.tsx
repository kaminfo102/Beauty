...
const features = [
  ...
  },
  {
    ...
    description: 'بیش از ۵۰۰۰ نفر به ما اعتماد کرده‌اند'
  },
  {
    icon: Heart,
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              کلینیک زیبایی نیولایف با بیش از ۱۵ سال سابقه درخشان، یکی از معتبرترین مراکز زیبایی در کشور است. ما با بهره‌گیری از جدیدترین دستگاه‌های پزشکی و تیمی از متخصصان مجرب، خدماتی با بالاترین کیفیت را ارائه می‌دهیم.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
